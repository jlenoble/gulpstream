...
var preprocessDest = function preprocessDest(dest) {
...
var Streamer = function () {
  function Streamer() {
    ...
    var _pipe = pipe !== undefined ? new _polypipe2.default(pipe) : null;
    var _dest = dest !== undefined ? new (Function.prototype.bind.apply(_gulpdest2.default, [null].concat(_toConsumableArray(preprocessDest(dest)))))() : null;
